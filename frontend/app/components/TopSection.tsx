...
const TopSection = () => {
    return (
        <section className="relative h-screen flex flex-col justify-around items-center px-[10%]">
            <Image className="absolute w-full h-full object-cover object-center" src="/background image.png" width={1920} height={1080} alt="image de fond" />
            ...
            <div className="relative flex flex-col justify-center items-center max-w-80">
                ...
                <button type="button" className="" title="voir">
