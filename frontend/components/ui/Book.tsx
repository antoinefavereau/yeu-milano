...
const EyeIcon = (
  <svg
    ...
    className="icon icon-tabler icon-tabler-zoom-in see modalImage"
    width="24"
    height="24"
    viewBox="0 0 24 24"
    strokeWidth="1.5"
...
const PagePair: React.FC<PagePairProps> = ({
  frontImage,
  backImage,
  className = "",
  onClick,
...
const Book: React.FC<BookProps> = ({ images, className = "" }) => {
  ...
  return (
    <div className={`book ${pageIndex === 0 ? "" : "open"} ${className}`}>
